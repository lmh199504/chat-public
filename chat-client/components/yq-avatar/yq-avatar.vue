		...
		<view class="oper-wrapper" :style="{display: sD, top:tp}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<view class="my-view" @click="fSelect" hover-class="hover" :style="{width: bW}"><view>重选</view></view>
					<view class="my-view" @click="fClose" hover-class="hover" :style="{width: bW}"><view>关闭</view></view>
					<view class="my-view" @click="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><view>旋转</view></view>
					<view class="my-view" @click="fPreview" hover-class="hover" :style="{width: bW}"><view>预览</view></view>
					<view class="my-view" @click="fUpload" hover-class="hover" :style="{width: bW}"><view>上传</view></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload" hover-class="hover" :style="{width: bW}"><view>上传</view></view>
				</view>
			</view>
		</view>
	</view>
